...
const Header = () => {
    return (
        <div className="relative bg-indigo-50 flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0">
            ...
            <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
                <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
                    ...
                    <div className="flex items-center">
                        ...
                        <Link href="/"
                            aria-label=""
                            className="inline-flex items-center font-semibold text-gray-800 transition-colors duration-200 hover:text-deepPurple-700"
                        >
                            Find a Registry
                        </Link>
                    </div>
