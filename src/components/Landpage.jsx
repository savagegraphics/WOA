            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-2">
                <div className="m-auto overflow-hidden rounded-lg shadow-lg cursor-pointer h-90 w-60 md:w-80">
                    <a href="#" className="block w-full h-full">
                        <div style={ { backgroundColor: '#fff' } } className="w-full p-4 bg-white dark:bg-gray-800">
                            <BsFilePlus className="ml-16 lg:ml-28 mt-8 mb-8" size={ 44 } color='#85586F' />
                            <p style={ { color: '#85586F' } } className="mb-2 text-xl pl-4 pr-4 font-bold text-[#85586F] dark:text-white">
                                Create a Babylist
                            </p>
                            <p style={ { color: '#606C5D' } } className="font-light pl-4 pr-2 text-gray-400 dark:text-gray-300 text-md">
                ...
                <div className="m-auto overflow-hidden rounded-lg shadow-lg cursor-pointer h-90 w-60 md:w-80">
                    <a href="#" className="block w-full h-full">
                        <div style={ { backgroundColor: '#fff' } } className="w-full p-4 bg-white dark:bg-gray-800">
                            ...
                            <p style={ { color: '#606C5D' } } className="font-light pl-4 pr-3 lg:pl-2 lg:pr-0 text-gray-400 dark:text-gray-300 text-md">
